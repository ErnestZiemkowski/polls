...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        Page<Poll> polls = pollDAO.findAll(pageable);
    ...
    public PagedResponse<PollResponse> getPollsCreatedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.Direction.DESC, "createdAt");
        Page<Poll> polls = pollDAO.findByCreatedBy(user.getId(), pageable);
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.Direction.DESC, "createdAt");
        Page<Long> userVotedPollIds = voteDAO.findVotedPollIdsByUserId(user.getId(), pageable);
        ...
        List<Poll> polls = pollDAO.findByIdIn(pollIds, sort);
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        List<ChoiceVoteCount> votes = voteDAO.countByPollIdGroupByChoiceId(pollId);

        Map<Long, Long> choiceVotesMap = votes.stream()
                .collect(Collectors.toMap(ChoiceVoteCount::getChoiceId, ChoiceVoteCount::getVoteCount));

        // Retrieve poll creator details
        User creator = userDAO.findById(poll.getCreatedBy())
                .orElseThrow(() -> new ResourceNotFoundException("User", "id", poll.getCreatedBy()));

        // Retrieve vote done by logged in user
        Vote userVote = null;
        if(currentUser != null) {
            userVote = voteDAO.findByUserIdAndPollId(currentUser.getId(), pollId);
        }
    ...
    private Map<Long, Long> getChoiceVoteCountMap(List<Long> pollIds) {
        ...
        List<ChoiceVoteCount> votes = voteDAO.countByPollIdInGroupByChoiceId(pollIds);
    ...
    private Map<Long, Long> getPollUserVoteMap(UserPrincipal currentUser, List<Long> pollIds) {
        ...
        if(currentUser != null) {
            List<Vote> userVotes = voteDAO.findByUserIdAndPollIdIn(currentUser.getId(), pollIds);
    ...
    Map<Long, User> getPollCreatorMap(List<Poll> polls) {
        ...
        List<User> creators = userDAO.findByIdIn(creatorIds);
